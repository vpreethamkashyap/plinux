...
{
	int len=0;
	printk(KERN_INFO "Inside hold entr \n");
...
int semdemo_init (void) 
{
	...
	if (IS_ERR(device_create(cl, NULL, dev, NULL, "sem%d", 0)))
	{
		class_destroy(cl);
		cdev_del(&c_dev);
		unregister_chrdev_region(dev, MINOR_CNT);
...
/*********************************
[51655.771176]  Inside cleanup_module
[51658.258779] Major Nr: 243
tsp@tsp-Inspiron-5558:~/tlinux/mylinux/Tools/6-Driver/e_kernel_synch/synchronization/3$ ls /dev/sem0
/dev/sem0
...
[51800.629349] Inside open
[51800.629355] State after = 0

tsp@tsp-Inspiron-5558:~$ sudo echo /proc/hold
/proc/hold
tsp@tsp-Inspiron-5558:~$
