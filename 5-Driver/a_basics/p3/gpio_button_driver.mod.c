...
__attribute__((section("__versions"))) = {
	...
	{ 0xba1001f9, __VMLINUX_SYMBOL_STR(gpiod_set_debounce) },
	{ 0xa5bc19cf, __VMLINUX_SYMBOL_STR(gpiod_direction_input) },
	{ 0x47229b5c, __VMLINUX_SYMBOL_STR(gpio_request) },
	{ 0xd6b8e852, __VMLINUX_SYMBOL_STR(request_threaded_irq) },
	{ 0x19a16b6f, __VMLINUX_SYMBOL_STR(irq_get_irq_data) },
...
MODULE_ALIAS("of:N*T*Cmy-button-driver*");
