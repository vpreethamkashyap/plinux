...
#include <sqlite3.h>
#include <sys/time.h>
#include "../inc/SerialComPort.h"

static unsigned char Sbuffer [COM_PACKET_MAX_SZ];

/*************************************************************************************************************
**		function 	 		:	 	ArgOpenSerialPort
...
/*************************************************************************************************************
**		function 	 		:	 	nu_SerialComPort_Open
**		Definition   	:		Opens the serial port 
**
**************************************************************************************************************/
...
/*************************************************************************************************************
**		function 	 		:	 	nu_SerialComPort_Close
**		Definition   	:		This closes/frees the Serial Com Port Device 
**
...
/*************************************************************************************************************
**		function 	 		:	 	nu_SerialComPort_Init
**		Definition   	:		Initializes the Serial Com Port Device according to the standard
...
/*************************************************************************************************************
**		function 	 		:	 	nu_SerialComPort_Getbaud
**		Definition   	:		Returns the currest operating baud rate of the Serial Com Port
...
/*************************************************************************************************************
**		function 	 		:	 		nu_SerialComPort_BlockRead
**		Definition   	:		 	Reads one whole ComPacket and sends it back to the calling function.
...
/*************************************************************************************************************
**		function 	 		:	 timeout_SerialComPort_BlockRead
**		Definition   	:
**
**************************************************************************************************************/
