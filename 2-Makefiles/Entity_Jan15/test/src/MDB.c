...
***************************************************************************************************************************************************** 
	...
	could be fdwritten before timeout occurs, then the function should return TRUE and set pNoOfBytesWritten to the actual number of bytes 
	written.
	Parameters: 
...
unsigned char  WritePacket(short int noOfBytesToWrite)
{
	...
	write(MDB_fd,mdbReqAdu.TxBuffer,noOfBytesToWrite);	
